...
def save_routes(routes_df: pd.DataFrame, data_folder: Optional[str] = None) -> None:
    """
...
def save_route_versions(route_versions_df: pd.DataFrame, data_folder: Optional[str] = None) -> None:
    """
...
def save_shape_variants(shape_variants_df: pd.DataFrame, data_folder: Optional[str] = None) -> None:
    """
...
def save_shapes(shapes_df: pd.DataFrame, data_folder: Optional[str] = None) -> None:
    """
...
def save_all_processed_data(shapes_df: pd.DataFrame, routes_df: pd.DataFrame,
    ...
    Args:
        ...
        data_folder: Custom data folder path. If None, uses default.
    """
    save_shapes(shapes_df, data_folder)
    save_routes(routes_df, data_folder)
    save_route_versions(route_versions_df, data_folder)
    save_shape_variants(shape_variants_df, data_folder)
    save_shape_variant_activations(shape_variant_activations_df, data_folder)
    save_temporary_changes(temporary_changes_df, data_folder)
